...
type Promo = { name: string; value: number };
defineProps<{ promos: Promo[] }>();
</script>

<template>
	<ul class="text-xs text-black">
		<li class="py-3 flex justify-between items-center gap-6 border-b border-b-[rgba(0,0,0,0.04)]">
